  ...
  <div style="font-family: Arial, sans-serif; max-width: 780px; margin: auto; border: 1px solid #ddd; border-radius: 8px; padding: 20px;">
    ...
    <div>
      ...
      <p style="font-size: 15px; color: #333; text-align: justify;">
       Permohonan Anda telah kami terima dengan nomor Ajuan <strong>${ID_Ajukan}</strong> dengan jenis ajuan <strong>${formName}</strong> pada tanggal <strong>${Tanggal_Pembuatan_Ajukan}</strong>. Permohonan Anda dan akan segera kami proses. Jika ada informasi tambahan yang diperlukan, kami akan menghubungi Anda kembali. Terima kasih.<br />
      </p>
