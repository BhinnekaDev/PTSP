const kirimEmailKadaluwarsa = async (toEmail, Nama_Lengkap, ID_Pemesanan) => {
  const htmlContent = `
  <div style="font-family: Arial, sans-serif; max-width: 750px; margin: auto; border: 1px solid #ddd; border-radius: 8px; padding: 20px;">
    ...
    Kami informasikan bahwa permohonan Anda dengan nomor pesanan <strong>${ID_Pemesanan}</strong> 
    telah <strong>kadaluwarsa</strong> karena melebihi batas waktu pembayaran yang ditentukan.<br /><br />
    Untuk memproses kembali permohonan Anda, silakan ajukan permintaan Virtual Account baru 
    melalui website kami. Kami mohon maaf atas ketidaknyamanan ini.<br />
...
export default kirimEmailKadaluwarsa;
